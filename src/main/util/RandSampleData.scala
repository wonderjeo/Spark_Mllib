...
object RandSampleData extends Serializable {
  // Rosenbrock:
  //¡Æ(100*(x(i+1)-x(i) 2) 2 + (x(i)-1) 2)
  // Rastrigin:
  //¡Æ(x(i) 2 -10*cos(2*3.14*x(i))+10)
  // Sphere :
  //¡Æ(x(i) 2)
  /**
   * ²âÊÔº¯Êý: Rosenbrock, Rastrigin
   * Ëæ»úÉú³Én2Î¬Êý¾Ý£¬²¢¸ù¾Ý²âÊÔº¯Êý¼ÆËãY
   * n1 ÐÐ£¬n2 ÁÐ£¬b1 ÉÏÏÞ£¬b2 ÏÂÏÞ£¬function ¼ÆËãº¯Êý
   */
  def RandM(
    n1: Int,
    n2: Int,
